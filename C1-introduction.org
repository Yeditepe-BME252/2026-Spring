...
* ($\S 1.11$) Elementary Ideas and Topics
** Fundamentals
...
- The moment of momentum of the body can be expressed by introducing the moment operation into integration in the form of the vector product with the position vector from the point about which moment is taken, $O$ for example
